...
switch($method)
{
    ...
    case "GET":
        $x = $_GET['id'];
        $sql = "SELECT * FROM music WHERE id = $x ";
    ...
    case "PUT":
        ...
        if ($contentType == "application/json") {
            ...
            if (!isset($json->nummer) || $json->nummer == "" || !isset($json->artiest) || $json->artiest == "" || $json->album == "" ||  !isset($json->album))
            {
            ...
            else
            {
                ...
                $sql = "UPDATE music SET nummer='$name', artiest='$artist', album='$album' WHERE id = $x";
    ...
    case "DELETE":
        $x = $_GET['id'];
        $sql = "DELETE FROM music WHERE id = $x";
