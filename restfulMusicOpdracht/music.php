...
switch($method)
{
    ...
    case "GET":
        ...
        if ($accept == "application/json") {
            header("Content-Type: application/json");
                           $sql = "SELECT * FROM music $limitstring $startstring";
                ...
                if ($result->num_rows > 0) {
                    ...
                    $totalItems = mysqli_num_rows($con->query("SELECT * FROM music "));
    ...
    case "POST":
        ...
        if ($contentType == "application/json") {
            ...
            if (isset($json->nummer) && isset($json->artiest) && isset($json->album) ) {
                $name = $json->nummer;
                $artist = $json->artiest;
                $album = $json->album;
                $sql = "INSERT INTO `0894594`.`music` (`id`, `nummer`, `artiest`, `album`) VALUES (NULL, '$name', '$artist', '$album');";
            ...
            if (isset($_POST["nummer"]) && isset($_POST["artiest"]) && isset($_POST["album"])) {
                $name = $_POST["nummer"];
